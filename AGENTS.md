...
- This folder is symlinked in Obsidian, so ther user can test the changes manually by reloading the plugin in Obsidian after building.
...
Obsidian Plugin API documentation is available at: https://docs.obsidian.md

- e.g.: https://docs.obsidian.md/Reference/TypeScript+API/AbstractInputSuggest/getSuggestions
